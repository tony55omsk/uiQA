import PageAutoresation.AutoresationPage;
...
public class UITest {
    ...
    public void test(){
        ...
        AutoresationPage loginPage = new AutoresationPage();

        loginPage.sendLogin("111");                  //Selenide.$(By.xpath("//*[@id=\"mobileOrEmail\"]")).setValue("111");
        loginPage.sendPassword("111");            //Selenide.$(By.xpath("//*[@id=\"password\"]")).setValue("111");
        loginPage.clickButtomOk();                             //Selenide.$(By.xpath("//*[@id=\"loginByPwdButton\"]")).click();
